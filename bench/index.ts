...
function parseWithStdUrl(input: string) {
...
function parseWithNodeUrl(input: string) {
...
function normalizeWithStdUrl(input: string) {
...
function normalizeWithNodeUrl(input: string) {
...
function benchmarkUrl(parse: (input: string) => { host: string; port: number | typeof None }) {
  let checksum = 0;
...
function benchmarkNormalizedUrl(
  parse: (input: string) => { normalizedHref: string }
) {
  let checksum = 0;
